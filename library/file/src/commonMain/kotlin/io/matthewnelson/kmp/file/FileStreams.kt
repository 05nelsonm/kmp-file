...
public expect sealed interface FileStream: Closeable {
     ...
     * @see [openReadWrite]
     * */
    public sealed interface ReadWrite: Read, Write {
         ...
         * */
        @Throws(IOException::class)
        public override fun position(new: Long): ReadWrite
         ...
         * */
        @Throws(IOException::class)
        public fun size(new: Long): ReadWrite
         ...
         * */
        @Throws(IOException::class)
        public override fun write(buf: ByteArray)
         ...
         * */
        @Throws(IOException::class)
        public override fun write(buf: ByteArray, offset: Int, len: Int)
    }
}
